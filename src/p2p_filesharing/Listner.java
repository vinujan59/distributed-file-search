...
public class Listner implements Runnable {
    ...
    private void unregister_ok(StringTokenizer  stringTokenizer) {
        String unregisterResponse = stringTokenizer.nextToken();
        if(unregisterResponse.equals("0")){
            System.out.println("unregister successful");
            return ;
        }
        System.out.println("unregister uknown "+ unregisterResponse);
    }
